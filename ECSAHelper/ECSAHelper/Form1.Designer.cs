namespace ECSAHelper
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.buttonConstitution = new System.Windows.Forms.Button();
			...
			// UpdateTab
			// 
			this.UpdateTab.Controls.Add(this.buttonConstitution);
			...
			// buttonConstitution
			// 
			this.buttonConstitution.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.buttonConstitution.Location = new System.Drawing.Point(84, 330);
			this.buttonConstitution.Name = "buttonConstitution";
			this.buttonConstitution.Size = new System.Drawing.Size(124, 23);
			this.buttonConstitution.TabIndex = 23;
			this.buttonConstitution.Text = "Update Constitution...";
			this.buttonConstitution.UseVisualStyleBackColor = true;
			this.buttonConstitution.Click += new System.EventHandler(this.buttonConstitution_Click);
			// 
			// labelOutput
			// 
			...
			this.buttonSaveUpdate.Location = new System.Drawing.Point(301, 330);
